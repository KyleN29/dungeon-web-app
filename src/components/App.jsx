...
function App() {
  ...
  return (
    ...
    <div  className='flex flex-col items-center justify-center w-[80%] mx-auto p-0 m-0'>
        <div id="flashTarget" className='w-full max-w-[700px] aspect-[1/1] rounded-sm flex justify-center items-center'>
            <DungeonLayout></DungeonLayout>
        </div>
        <div  className='w-full h-[200px] max-w-[700px] flex justify-start items-start flex-col-reverse overflow-auto bg-[rgb(19,19,19)] mb-[50px]'>
